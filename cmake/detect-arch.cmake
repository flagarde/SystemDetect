...
if(NOT ARCH OR ARCH STREQUAL "unknown")
  ...
  message(WARN "Arch not recognized, falling back to cmake arch: '${ARCH}'")
else()
  message(NOTE "Arch detected: '${ARCH}'")
endif()
...
elseif("${ARCH}" MATCHES "riscv(32|64)")
  ...
  set(BASEARCH "x86")
  set(BASEARCH_X86_FOUND TRUE)
  message(WARN "Basearch '${ARCH}' not recognized, defaulting to 'x86'.")
endif()
message(NOTE "Basearch of '${ARCH}' has been detected as: '${BASEARCH}'")
